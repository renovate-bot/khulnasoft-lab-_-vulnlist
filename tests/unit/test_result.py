...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            [
                workspace.File(digest="58f05c2a3d05c26e", path="results/dummy-result-3.json", algorithm="xxh64"),
                workspace.File(digest="dbffc621d621b2bb", path="results/dummy-result-4.json", algorithm="xxh64"),
            ],
            2,
        ),
        (
