...
def get_schema_repo_path(url: str) -> str:
    # e.g. https://raw.githubusercontent.com/khulnasoft-lab/vulnlist/main/schema/vulnerability/nvd/schema-{version}.json
    relative_path = url.removeprefix("https://raw.githubusercontent.com/khulnasoft-lab/vulnlist/main/")
