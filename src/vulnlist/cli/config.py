...
from vulnlist import provider, providers
...
@dataclass
class Log:
    slim: bool = os.environ.get("VULNLIST_LOG_SLIM", default="false") == "true"
    level: str = os.environ.get("VULNLIST_LOG_LEVEL", default="INFO")  # noqa: RUF009
    show_timestamp: bool = os.environ.get("VULNLIST_LOG_SHOW_TIMESTAMP", default="false") == "true"
    show_level: bool = os.environ.get("VULNLIST_LOG_SHOW_LEVEL", default="true") == "true"
...
def load(path: str = ".vulnlist.yaml") -> Application:
    try:
