...
from vulnlist import provider, result, schema
...
class Config:
    ...
    #
    # token: str = "env:VULNLIST_AWESOME_TOKEN"
    #
...
class Provider(provider.Provider):
    ...
    def update(self, last_updated: datetime.datetime | None) -> tuple[list[str], int]:
        ...
        # https://github.com/khulnasoft-lab/vulnlist/blob/main/src/vulnlist/providers/nvd/manager.py
